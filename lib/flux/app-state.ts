    ...
    newNote: {
      creator({
        ...
        return (dispatch, getState: () => State) => {
          // TODO: Once we can handle the Simperium side-effects
          //       in middleware then this action will be the thing
          //       that is called instead of `actionCreators.newNote()`
